...
public class ApplicationConfig implements CommandLineRunner  {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cliente5 = new Cliente(5L,"Igor Motta", "joao.silva@ibm.com",994618524L);
		Cliente cliente6 = new Cliente(6L,"Teo Nunes", "ana.maria@ibm.com",994618522L);
		Cliente cliente7 = new Cliente(7L,"Leonardo Martins", "thiago.alves@ibm.com",994618523L);
		Cliente cliente8 = new Cliente(8L,"Paula Bordalo", "juliana.souza@ibm.com",994618523L);
